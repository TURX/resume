...
\section{""" + structure.translate({
...
}) + r"}" + "\n" + r"\small{" + structure.item_list([
    {
        ...
        "ja": r"\textbf{ACM-ICPC (国際大学対抗プログラミングコンテスト):} 銀メダル (96チーム中7位) (2021年ICPC北中米地区大会, チーム THREE\_PUPILS); ランキング (118チーム中26位) (2021年ICPC北中米地区大会, チーム GEKOta)",
    ...
    # -10,  # vspace
    {
        ...
        "ja": r"\textbf{ACSL (アメリカコンピューターサイエンスリーグ) 上級コース}",
    ...
    },
    {
        ...
        "ja": r"\textbf{NOIP 中国情報オリンピック省大会:} 上級コース2等賞 (2019年, 2020年), 上級コース3等賞 (2018年), 初級コース2等賞 (2017年)",
