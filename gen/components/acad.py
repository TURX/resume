...
resumeSubHeadings: type.ResumeSubHeadingList = [
    ...
    },
    {
        ...
        "body": structure.item_list([
            {
                "en": r"Machine teaching research in Prof. Xiaojin Jerry Zhu's group through WISCERS program. \href{https://pages.cs.wisc.edu/~ruixuan/wiscers-23}{\ul{\emph{implementations}}}",
                "ja": r"WISCERSプログラムを通じて、Xiaojin Jerry Zhu教授のリサーチグループで機械教示の研究をした\\ \href{https://pages.cs.wisc.edu/~ruixuan/wiscers-23}{\underline{\emph{実装}}}",
                "zh": r"通过WISCERS项目，在 Xiaojin Jerry Zhu 教授的研究小组中从事机器教学研究 \href{https://pages.cs.wisc.edu/~ruixuan/wiscers-23}{\underline{\emph{实现}}}"
            }
        ]),
        "tag": ["resume"]
    },
